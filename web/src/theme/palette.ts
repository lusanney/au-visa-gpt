...
export const SUCCESS = { lighter: '#D8FBDE', light: '#86E8AB', main: '#16A34A', dark: '#15803D', darker: '#0F5C2C', contrastText: '#fff' } as const;
export const WARNING = { lighter: '#FFF5CC', light: '#FFD666', main: '#D97706', dark: '#B45309', darker: '#7C2D12', contrastText: '#0B1220' } as const;
export const ERROR   = { lighter: '#FFE9D5', light: '#FFAC82', main: '#DC2626', dark: '#B91C1C', darker: '#7F1D1D', contrastText: '#fff' } as const;
...
export const mantineBrandScale: MantineColorsTuple = [
  '#E6F9FB', '#C9F1F4', '#AEE8EC', '#91DEE4', '#73D3DB',
  '#54C7D0', '#33BAC4', '#18AEB9', '#0FA3B1', '#0B8894',
] as const;

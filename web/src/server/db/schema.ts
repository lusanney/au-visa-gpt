...
export const applications = pgTable(
  ...
  (t) => [index("applications_visa_idx").on(t.visaCode.asc())],
);
...
export const ingestionJobs = pgTable(
  ...
  (t) => [index("ingestion_jobs_doc_status_idx").on(t.documentId.asc(), t.status.asc())],
);
...
export const ocrResults = pgTable(
  ...
  (t) => [index("ocr_results_doc_created_idx").on(t.documentId.asc(), t.createdAt.desc())],
);
